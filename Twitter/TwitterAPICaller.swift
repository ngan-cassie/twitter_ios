...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "OsnhFxMFRsk5kQ4pDqsIhCenX", consumerSecret: "j7MORBPzyMp5jjTg9TbaWSiaCRLjsBY52dzjUjAuc2K2hGqCd0")
    var loginSuccess: (() -> ())?
